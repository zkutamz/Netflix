...
--			name				phone			ADDRESS	 I      Dateofbirth		GENDER
values ('Admin',				'',					'',				'',				''),
		(N'Nguyễn Văn A',	'0398865561',	N'453 Hội An',		'2000/10/27',		2)

insert into ACCOUNT
--				mail				pass		ACCOUNT_TYPE	  INFORMATION_ID	IS_ACTIVE	
values	('admin@netflix.com',		'admin',		2,					1,				1),
		('test_user@netflix.com',	'123456',		1,					2,				1)
...
values	--Name							INFO_ID		POSTER_NAME			TRAILER_NAME							MOVIE_NAME						TYPE_ID		CATEGORY_ID		IS_ACTIVE
		('Blast Beat',					'0001', '0001_poster.jpg', 'BlastBeat_Trailer.mov',					'BlastBeat_Film.mov',					1,			1,				1),
		('Chasing Wonders',				'0002', '0002_poster.jpg', 'ChasingWonders_Trailer.mov',			'ChasingWonders_Film.mov',				3,			3,				1),
		('Death in Texas',				'0003', '0003_poster.jpg', 'DeathInTexas_Trailer.mov',				'DeathInTexas_Film.mov',				4,			4,				1),
		('Domino Battle of the Bones',	'0004', '0004_poster.jpg', 'DominoBattleOfTheBones_Trailer.mov',	'DominoBattleOfTheBones_Film.mov',		5,			5,				1),
		('Dream Horse',					'0005', '0005_poster.jpg', 'DreamHorse_Trailer.mov',				'DreamHorse_Film.mov',					1,			6,				1),
		('End Game',					'0006', '0006_poster.jpg', 'EndGame_Trailer.mov',					'EndGame_Film.mov',						2,			7,				1),
		('Flash Back',					'0007', '0007_poster.jpg', 'FlashBack_Trailer.mov',					'FlashBack_Film.mov',					3,			1,				1),
		('Free Guy',					'0008', '0008_poster.jpg', 'FreeGuy_Trailer.mov',					'FreeGuy_Film.mov',						4,			2,				1),
		('Fun House',					'0009', '0009_poster.jpg', 'FunHouse_Trailer.mov',					'FunHouse_Film.mov',					5,			3,				1),
		('Hero Mode',					'0010', '0010_poster.jpg', 'HeroMode_Trailer.mov',					'HeroMode_Film.mov',					1,			4,				1),
		('Hitman Wife BodyGuard',		'0011', '0011_poster.jpg', 'HitmanWifeBodyGuard_Trailer.mov',		'HitmanWifeBodyGuard_Film.mov',			2,			5,				1),
		('Old',							'0012', '0012_poster.jpg', 'Old_Trailer.mov',						'Old_Film.mov',							3,			6,				1),
		('Port Authority',				'0013', '0013_poster.jpg', 'PortAuthority_Trailer.mov',				'PortAuthority_Film.mov',				4,			7,				1),
		('Queen Bees',					'0014', '0014_poster.jpg', 'QueenBees_Trailer.mov',					'QueenBees_Film.mov',					5,			1,				1),
		('Space Jam a New Legacy',		'0015', '0015_poster.jpg', 'SpaceJamANewLegacy_Trailer.mov',		'SpaceJamANewLegacy_Film.mov',			2,			2,				1)
